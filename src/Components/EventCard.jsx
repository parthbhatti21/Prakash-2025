...
//             <NavLink to={"https://docs.google.com/spreadsheets/d/1cC0-tgQUeavTXRqKDG6hZNZS9u72UIbJQ3xUpbEChpE/edit?usp=sharing"}>
//               <h3>{selectedEventDetails.formname}</h3>
//             </NavLink>
//             {selectedEventDetails.contact && (
//               <div className="contact-info">
//                 <p>For further details contact:</p>
//                 <p>{selectedEventDetails.contact.name} : {selectedEventDetails.contact.phone}</p>
//               </div>
//             )}
//             <NavLink to={selectedEventDetails.link} target="_blank">
